...
export function MusicToggle() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.9 }}
      onClick={toggleMusic}
      className="fixed top-6 right-6 z-[100] w-12 h-12 bg-white border-4 border-amber-900/10 rounded-full shadow-2xl flex items-center justify-center text-amber-900 hover:text-emerald-600 transition-all group"
